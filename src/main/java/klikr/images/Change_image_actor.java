...
//**********************************************************
{
    ...
    //**********************************************************
    {
        try(Perf p = new Perf("Change_image_actor")) {
            ...
            if (dbg) change_image_message.image_window.context.log("delta=" + change_image_message.delta);

            if (change_image_message.image_window == null) {
                if (dbg) change_image_message.image_window.context.log(Logger.error+"FATAL change_image_message.image_stage == null");
                return "Failed change_image_message.image_stage == null";
            }
            if (change_image_message.image_window.image_display_handler == null) {
                if (dbg)
                    change_image_message.image_window.context.log(Logger.error+"FATAL change_image_message.image_stage.image_display_handler == null");
            ...
            if (change_image_message.image_window.image_display_handler.image_indexer == null) {
                if (dbg)
                    change_image_message.image_window.context.log("warning: change_image_message.image_stage.image_display_handler.image_indexer  == null (probably in the making)");
                if (change_image_message.input_image_context.path == null) {
                    if (dbg) change_image_message.image_window.context.log("change_image_message.input_image_context.path == null");
            ...
            if (change_image_message.input_image_context == null) {
                if (dbg) change_image_message.image_window.context.log("change_image_message.input_image_context == null");
                change_image_message.image_window.set_nothing_to_display(null);
            ...
            if (change_image_message.input_image_context.previous_path == null) {
                if (dbg)
                    change_image_message.image_window.context.log("change_image_message.input_image_context.previous_path == null");
                change_image_message.image_window.set_nothing_to_display(null);
            ...
            if (change_image_message.get_aborter().should_abort()) {
                change_image_message.image_window.context.log("Change_image_actor aborted from: " + change_image_message.get_aborter().name);
                return "aborted";
            }
            ...
            if (change_image_message.delta != 0) {
                ...
                target_path = x.get_new_path_relative(
                        change_image_message.input_image_context.previous_path, change_image_message.delta, change_image_message.ultimate, change_image_message.image_window.context.aborter());
            } else {
                target_path = change_image_message.input_image_context.path;
            }

            if (dbg) change_image_message.image_window.context.log("Change_image_actor target_path=" + target_path);
            if (target_path == null) {
                if (dbg)
                    change_image_message.image_window.context.log("Change_image_actor change_image_relative something really bad happened, like the whole dir was deleted behind the scene");
                change_image_message.image_window.set_nothing_to_display(null);
    ...
    //**********************************************************
    {
        ...
        {
            if (dbg)
                change_image_message.image_window.context.log("Change_image_actor change_image_relative target = " + target_image_path);
            ...
            if (image_context != null) {
                if (dbg) change_image_message.image_window.context.log("\nimage FOUND in cache");
                ...
                Jfx_batch_injector.inject(() -> change_image_message.image_window.set_image_internal(change_image_message.output_image_context[0]), change_image_message.image_window.context);
                //cim.image_stage.restore_cursor();
            ...
            if (option.isEmpty()) {
                if (dbg) change_image_message.image_window.context.log("Change_image_actor null image (1) in change_image_relative");
            ...
            if (change_image_message.image_window.mouse_handling_for_image_window.something_is_wrong_with_image_size()) {
                if (dbg)
                    change_image_message.image_window.context.log("Change_image_actor something_is_wrong_with_image_size in change_image_relative");
                //image_stage.restore_cursor();
                //return;
            } else {
                if (dbg) {
                    change_image_message.image_window.context.log(
