...
//**********************************************************
{
    ...
    //**********************************************************
    public static void save_boolean(String s, boolean b, Kontext context)
    //**********************************************************
    {
    ...
    //**********************************************************
    public static void manage_show_ffmpeg_install_warning(Kontext context)
    //**********************************************************
    {
        if ( Feature_cache.get(Feature.Show_ffmpeg_install_warning))
        {
            if ( show_ffmpeg_install_warning_done)
            {
                context.log("ffmpeg warning already shown to the user, in this session");
                return;
            }
            ...
            Platform.runLater(()->{
                if ( Popups.info_popup(msg, GOT_IT_DONT_SHOW_ME_THIS_AGAIN,context))
                {
                    Feature_cache.update_cached_boolean(Feature.Show_ffmpeg_install_warning, false,context);
                }
            });
        }
    }
    ...
    //**********************************************************
    public static void manage_show_graphicsmagick_install_warning(Kontext context)
    //**********************************************************
    {
        if ( Feature_cache.get(Feature.Show_graphicsmagick_install_warning))
        {
            ...
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    if ( Popups.info_popup(msg,GOT_IT_DONT_SHOW_ME_THIS_AGAIN,context))
                    {
                        Feature_cache.update_cached_boolean(Feature.Show_graphicsmagick_install_warning, false,context);
                    }
    ...
    //**********************************************************
    public static void manage_show_fpcalc_install_warning(Kontext context)
    //**********************************************************
    {
        if ( Feature_cache.get(Feature.Show_fpcalc_install_warning))
        {
            ...
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    if ( Popups.info_popup(msg,GOT_IT_DONT_SHOW_ME_THIS_AGAIN,context))
                    {
                        Feature_cache.update_cached_boolean(Feature.Show_fpcalc_install_warning, false,context);
                    }
    ...
    //**********************************************************
    public static void manage_show_imagemagick_install_warning(Kontext context)
    //**********************************************************
    {
        if ( Feature_cache.get(Feature.Show_imagemagick_install_warning))
        {
            ...
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    if ( Popups.info_popup(msg,GOT_IT_DONT_SHOW_ME_THIS_AGAIN,context))
                    {
                        Feature_cache.update_cached_boolean(Feature.Show_imagemagick_install_warning, false,context);
                    }
    ...
    //**********************************************************
    public static void manage_show_mediainfo_install_warning(Kontext context)
    //**********************************************************
    {
        if ( Feature_cache.get(Feature.Show_mediainfo_install_warning))
        {
            ...
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    if ( Popups.info_popup(msg,GOT_IT_DONT_SHOW_ME_THIS_AGAIN,context))
                    {
                        Feature_cache.update_cached_boolean(Feature.Show_mediainfo_install_warning, false,context);
                    }
    ...
    //**********************************************************
    public static void manage_show_ytdlp_install_warning(Kontext context)
    //**********************************************************
    {
        if ( Feature_cache.get(Feature.Show_ytdlp_install_warning))
        {
            ...
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    if ( Popups.info_popup(msg,GOT_IT_DONT_SHOW_ME_THIS_AGAIN,context))
                    {
                        Feature_cache.update_cached_boolean(Feature.Show_ytdlp_install_warning, false,context);
                    }
