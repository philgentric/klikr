...
//**********************************************************
{
    ...
    private TextArea the_text_area = new TextArea();
    ;
    //**********************************************************
    public Per_folder_mini_console(Kontext context)
    //**********************************************************
    {
    ...
    //**********************************************************
    {
        ...
        if (all_files == null)
        {
            context.log("NO files in: " + target_dir);
            return;
        }
        ...
        for (File f : all_files)
        {
            if (!f.isDirectory())
            {
                if (!Guess_file_type.should_ignore(f.toPath(),context.logger()))
                {
                    target_file_count++;
                }
            }
        ...
        context.log("Looking at :" + target_dir + " file count here is : " + target_file_count);
        show_progress();
    }
    ...
    //**********************************************************
    {
        ...
        if ( processed_file_count.doubleValue() == target_file_count)
        {
            ...
            Actor_engine.execute(r, "Monitor backup",context.logger());
        }
