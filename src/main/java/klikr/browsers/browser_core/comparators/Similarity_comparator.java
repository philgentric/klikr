...
//**********************************************************
{
    ...
    //**********************************************************
    public Similarity_comparator(Supplier<Feature_vector_cache> fv_cache_supplier, Similarity_cache similarity_cache, Path_list_provider path_list_provider, Kontext context)
    //**********************************************************
    {
        this.context = context;
        this.fv_cache_supplier = fv_cache_supplier;
        this.similarity_cache = similarity_cache;
        this.images = path_list_provider.only_image_paths(false,Feature_cache.get(Feature.Show_hidden_files),context.aborter());
        shuffle();
    }
    ...
    //**********************************************************
    {
        ...
        if ( dummy_name2 == null)
        {
            context.log(" dummy_name2 == null for "+p2);
        ...
        //context.log("compare "+p1+" vs "+p2+" == "+d);
        return d;
    }
    ...
    protected void add_non_images(Path_list_provider path_list_provider, int i) {
        ...
        for ( Path path : path_list_provider.only_file_paths(false,Feature_cache.get(Feature.Show_hidden_files),context.aborter()) )
        {
