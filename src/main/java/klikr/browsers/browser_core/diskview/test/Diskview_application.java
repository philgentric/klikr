package klikr.browsers.browser_core.diskview.test;
...
public class Diskview_application extends Application {
    ...
    public Diskview_application(Kontext k)
    {
        this.context = k;
    }
    ...
    {
        context = new Kontext(stage,context.aborter(),context.logger());
        ...
        toolBar.getItems().addAll(btnOpen, btnRefresh, back_button, new Separator(), status_label);
        root.setTop(toolBar);
