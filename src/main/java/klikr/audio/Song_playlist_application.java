...
//**********************************************************
{
    ...
    //**********************************************************
    {
        ...
        Path_list_provider path_list_provider = new Path_list_provider_for_playlist(path,  context);

        Owner_provider window_provider = Window_builder.additional_no_past(this,Window_type.Song_playlist,path_list_provider,context);
        new Disk_usage_and_caches_monitor(context).start();

        Klikr_communicator klikr_communicator = new Klikr_communicator("Song playlist app",context);
